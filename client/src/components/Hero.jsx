  ...
  return (
    ...
    min-h-screen'>
      ...
      <div className='text-center mb-6'>
        ...
        <span className='text-primary'>AI</span> <span className='text-primary'>tools</span></h1>
        <p className='mt-4 max-w-xs sm:max-lg 2xl:max-w-xl m-auto
...
rounded-lg border border-grey-300 hover:scale-102 active:scale-95 transition
